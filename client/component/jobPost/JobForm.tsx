...
function JobForm() {
  ...
  const renderStages = () => {
    switch (currentSection) {
      ...
      case "Location":
        return <JobLocation />;
      case "Summary":
        return <div>Summary</div>; // Placeholder
    }
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createJob({
      ...
      skills,
      negotiable,
      tags: [location.country, location.city, location.address].filter(Boolean),
    });
  ...
  return (
    <div className="w-full flex flex-col md:flex-row gap-6">
      <div className="self-start w-full md:w-[10rem] flex flex-row md:flex-col bg-white rounded-md shadow-sm overflow-hidden">
