...
"[project]/node_modules/currency.js/dist/currency.min.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
*/ (function(e, g) {
    ("TURBOPACK compile-time truthy", 1) ? module.exports = g() : "TURBOPACK unreachable";
    ...
    e.prototype = {
        ...
        distribute: function(b) {
            var a = this.intValue, d = this.p, c = this.s, h = [], k = Math[0 <= a ? "floor" : "ceil"](a / b), l = Math.abs(a - k * b);
        ...
        format: function(b) {
            var a = this.s;
            return "function" === typeof b ? b(this, a) : a.format(this, Object.assign({}, a, b));
        },
        toString: function() {
...
//# sourceMappingURL=node_modules_9bcadeda._.js.map