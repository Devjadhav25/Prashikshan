...
function Home() {
    ...
    const handleSearch = ()=>{
        if (jobTitle.trim()) {
            // Redirect to findwork page with the title as a query parameter
            router.push(`/findwork?title=${encodeURIComponent(jobTitle)}`);
        } else {
...
//# sourceMappingURL=_12e34292._.js.map