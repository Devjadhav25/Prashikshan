...
;
;
/* Modernized Styles for your Login/Register Box */ const AuthContainer = "min-h-screen flex items-center justify-center bg-[#0a0a0a] overflow-hidden";
const GlassBox = "relative z-10 w-full max-w-md p-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl";
const InputStyle = "w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 outline-none transition-all";
const PrimaryButton = "w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg font-bold text-white hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-purple-500/20";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad07c8c1._.js.map