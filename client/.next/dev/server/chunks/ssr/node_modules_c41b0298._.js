...
"[project]/node_modules/currency.js/dist/currency.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function format(currency, settings) {
    var pattern = settings.pattern, negativePattern = settings.negativePattern, symbol = settings.symbol, separator = settings.separator, decimal = settings.decimal, groups = settings.groups, split = ('' + currency).replace(/^-/, '').split('.'), dollars = split[0], cents = split[1];
...
const __TURBOPACK__default__export__ = currency;
}),
...
//# sourceMappingURL=node_modules_c41b0298._.js.map